...
function overlayAddRollContactsListTemplate(i, contact, isChecked) {
    return /*html*/ `
        <div class="overlay-add-one-person-div" onclick="overlayAddAddAssignedPersons(${i})" id="overlayAddOnePersonDiv-${i}">
            <div class="overlay-add-one-person-div-left">
                <div class="overlay-add-assigned-person-initials" style="background-color:${contact.color}; color:white">${overlayAddProfileInitials(i)}</div>
...
function overlayAddShowAssignedPersonsTemplate(person, i) {
    return /*html*/ `
        <div class="overlay-add-assigned-person-div">
            <div class="overlay-add-assigned-person-initials" style="background-color:${person.color}; color:white">${overlayAddProfileInitials(i)}</div>
            <div>${person.name}</div>
            <img src="../assets/icon-overlay-task/close.svg" onclick="overlayAddRemoveAssignedPersons(${i})">
        </div>`;
}

function overlayAddRenderSubtasksTemplate(subtask, i) {
    return /*html*/ `
        <div class="overlay-add-subtask">
            <input type="checkbox" id="subtask-${i}" ${subtask.completed ? 'checked' : ''} onclick="toggleSubtask(${i})">
            <label for="subtask-${i}">${subtask.title}</label>
            <img src="../assets/icon-overlay-task/close.svg" onclick="removeSubtask(${i})">
        </div>`;
}

function overlayAddEditSubtaskTemplate(i) {
    return /*html*/ `
...
function overlayAddCreateTaskPopupTemplate() {
    return /*html*/ `
