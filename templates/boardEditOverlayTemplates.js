...
/**
 * This function is intended to display the large view of the task. HTML
 * @param {*} i 
 * @returns 
 */
function editTaskOverlayHTML(i){
    return `
  ...
  /**
 * This function renders the svg.
 * @returns 
 */
function prioritySignOverlayUrgentSvg(){
    return  `
   ...
   * @returns 
   */
  function prioritySignOverlayMediumSvg(){
    return `
   ...
   * @returns 
   */
  function prioritySignOverlayLowSvg(){
    return  `
